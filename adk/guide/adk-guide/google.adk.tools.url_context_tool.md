# Google ADK Tools URL Context Tool API Reference

`google.adk.tools.url_context_tool` 모듈의 API 레퍼런스 문서입니다.
...
URL에서 콘텐츠를 검색하고 해당 콘텐츠를 사용하여 응답을 알리고 형성하기 위해 Gemini 2 모델에 의해 자동으로 호출되는 내장 도구입니다.
