# Google ADK Tools Base Authenticated Tool API Reference

`google.adk.tools.base_authenticated_tool` 모듈의 API 레퍼런스 문서입니다.
...
실제 도구 로직이 호출되기 전에 인증을 처리하는 기본 도구 클래스입니다. 함수는 사용할 수 있도록 준비된 자격 증명인 특별한 credential 인자를 받을 수 있습니다. (실험적 기능)
